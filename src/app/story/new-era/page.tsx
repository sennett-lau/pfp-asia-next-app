...
const NewEra = () => {
  return (
    ...
    >
      <p>
        The history of blockchain is not long, but we know that with each wave
        comes a brand new narrative.
      </p>
      <p>
        At the same time, each new narrative brings forth new assets. The
        emergence of these new assets is not always easy. A brand-new asset in
        its infancy is often accompanied by numerous challenges and skepticism
        from participants who have experienced the previous cycle.
      </p>
      <p>Isn&apos;t that so?</p>
      <p>
        BTC represents the birth of cryptocurrency. Before their success,
        traditional financial giants chose to ignore them. These old money
        believed that BTC could never surpass gold. They watched from a
        distance, full of disdain and mockery. But now, who has been proven
        wrong?
      </p>
      <p>
        Uniswap, with its AMM mechanism for DEX and DeFi. At that time, TVL,
        vampire attacks, and liquidity pools were not widely known. The miners
        who enjoyed the benefits of PoW chose to mock. They firmly believed that
        CEX and mining farms were the future of everything. But now, who has
        been proven wrong?
      </p>
      <p>
      ...
      <p>
        ...
        revolutionary protocol challenging traditional asset concepts. We view
        this innovative protocol, incorporating both fragmentation and
        integration, as the most promising new asset for the next cycle.
      </p>
      <p>
      ...
      <p>
        ...
        as the impossible triangle? We, too, have felt skeptical in self-doubt.
        Fortunately, our experienced development team has initiated EIP
        proposals and has received incredible attention.
      </p>
      <p>
        Users of new assets may not necessarily be enthusiasts of old assets.
        Many founders, when launching a project, are eager to find survivors
        from the old era. People often believe in survivors, believing that
        success can be replicated. However, we know that success may be
      ...
      <p>
        ...
        after they saw our Demo circulating only internally, some leading
        investors praised us, saying they see the potential for OpenSea / Blur
        2.0 in us.
      </p>
      <p>
